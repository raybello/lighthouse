...
class TestExpressionDetection:
    ...
    def test_has_expression_detects_simple_expression(self, expression_service):
    ...
    def test_has_expression_returns_false_for_plain_text(self, expression_service):
...
class TestExpressionExtraction:
    ...
    def test_extract_multiple_expressions(self, expression_service):
        ...
        expressions = expression_service.extract_expressions("{{first}} and {{second}}")
...
class TestNodeReferences:
    ...
    def test_simple_node_reference(self, expression_service, sample_context):
        """Test resolving a simple node reference."""
        result = expression_service.resolve('{{$node["Input"].data.name}}', sample_context)
        assert result == "John Doe"

    def test_numeric_property_reference(self, expression_service, sample_context):
        """Test resolving numeric property."""
        result = expression_service.resolve('{{$node["Input"].data.age}}', sample_context)
        assert result == 30

    def test_boolean_property_reference(self, expression_service, sample_context):
        """Test resolving boolean property."""
        result = expression_service.resolve('{{$node["Input"].data.active}}', sample_context)
        assert result is True

    def test_nested_property_reference(self, expression_service, sample_context):
...
class TestArithmetic:
    ...
    def test_addition(self, expression_service, sample_context):
        ...
        result = expression_service.resolve('{{$node["Input"].data.age + 10}}', sample_context)
        assert result == 40

    def test_subtraction(self, expression_service, sample_context):
        """Test arithmetic subtraction."""
        result = expression_service.resolve('{{$node["Input"].data.age - 5}}', sample_context)
        assert result == 25
...
class TestStringOperations:
    ...
    def test_string_concatenation_in_mixed_content(self, expression_service, sample_context):
    ...
    def test_multiple_substitutions(self, expression_service, sample_context):
    ...
    def test_numeric_to_string_conversion(self, expression_service, sample_context):
...
class TestDictResolution:
    ...
    def test_resolve_dict_with_expressions(self, expression_service, sample_context):
    ...
    def test_resolve_dict_with_list(self, expression_service, sample_context):
...
class TestErrorHandling:
    ...
    def test_nonexistent_node_reference(self, expression_service, sample_context):
        """Test that referencing non-existent node raises error."""
        with pytest.raises(ExpressionError, match="not found in context"):
            expression_service.evaluate_expression('$node["NonExistent"].data.foo', sample_context)

    def test_invalid_expression_syntax(self, expression_service, sample_context):
        """Test that invalid syntax raises error."""
        with pytest.raises(ExpressionError):
            expression_service.evaluate_expression("$node[invalid syntax", sample_context)
    ...
    def test_failed_expression_returns_original_in_resolve(
        ...
        result = expression_service.resolve('{{$node["NonExistent"].data.foo}}', sample_context)
...
class TestEdgeCases:
    ...
    def test_resolve_non_string_value(self, expression_service, sample_context):
    ...
    def test_resolve_string_without_expressions(self, expression_service, sample_context):
...
class TestComparisonOperations:
    ...
    def test_greater_than(self, expression_service, sample_context):
        ...
        result = expression_service.resolve('{{$node["Input"].data.age > 25}}', sample_context)
        assert result is True
    ...
    def test_equality(self, expression_service, sample_context):
        ...
        result = expression_service.resolve('{{$node["Input"].data.age == 30}}', sample_context)
        assert result is True
